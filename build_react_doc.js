...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      // ═══════════════════════════════════════════
      // NEW SECTION — DETAILED ANALYSIS OF 25 CORE CONCEPTS
      // ═══════════════════════════════════════════
      h1("Deep-Dive: 25 Core Frontend Concepts"),
      body("This section provides the comprehensive technical context for each core concept, including implementation details and architectural trade-offs."),
      space(),
